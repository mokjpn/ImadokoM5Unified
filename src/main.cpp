...
// パネル定義 Raspberry Pi Pico ラウンド液晶モジュール https://ssci.to/8432 
// LGFX_RPICO_SPI_GC9A01クラス定義は, サンプルプログラム https://github.com/urukakanko/RsPico_round_lcd/blob/main/RsPico_round_lcd_ClockSample/RsPico_round_lcd_ClockSample.ino より引用
...
//  lcd.setBrightness(20);
  ...
  lcd.println(F("[ImadokoPi]"));
  lcd.println();

  uint32_t* uid = (uint32_t*)0x10000004;
  clientID = "RasPiPicoW_" + String(*uid, HEX);
